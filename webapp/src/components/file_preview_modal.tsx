...
import { enableEditPermissions, filePreviewModal, makeGetCollaboraFilePermissions, makeGetIsCurrentUserFileOwner } from '@/selectors';
...
const FilePreviewModal: FC = () => {
  ...
  return (
    <FullScreenModal compact={true} show={visible && !inhibited}>
      <FilePreviewHeader
        fileInfo={fileInfo}
        onClose={handleClose}
        editable={editable}
      ...
      />
      <WopiFilePreview fileInfo={fileInfo} editable={editable} />
    </FullScreenModal>
  );
};
